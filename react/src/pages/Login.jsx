...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className='flex justify-center '>
        <button data-tooltip-target="tooltip-click" data-tooltip-trigger="click" type="button" className="ms-3 text-white bg-blue-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Credentials</button>
        <div id="tooltip-click" role="tooltip" className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-gray-700">
          Username: <span className='text-blue-500'>admin</span> <br />
          Password: <span className='text-blue-500'>admin</span>
